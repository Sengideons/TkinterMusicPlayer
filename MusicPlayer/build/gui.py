...
os.chdir(r'C:\Users\User\Desktop\MusicPlayer\build\songs')
songs = os.listdir()


button_image_1 = PhotoImage(
    file="C:\\MusicPlayer\\build\\images\\button_1.png")
...
resume_pic = PhotoImage(
    file="C:\\MusicPlayer\\build\\images\\button_2.png")
